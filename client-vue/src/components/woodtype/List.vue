        ...
        <tbody>
          <tr
            ...
            <td>
              <router-link
                v-if="item"
                :to="{name: 'WoodTypeShow', params: { id: item['@id'] }}">
                {{ item['@id'] }}
              </router-link>
            </td>
            <td>
            ...
            <td>
              <router-link :to="{name: 'WoodTypeUpdate', params: { id: item['@id'] }}">
                <span
                  class="fa fa-pencil"
                  aria-hidden="true" />
...
export default {
  computed: mapGetters({
    deletedItem: 'woodtype/del/deleted',
    error: 'woodtype/list/error',
    items: 'woodtype/list/items',
    isLoading: 'woodtype/list/isLoading',
    view: 'woodtype/list/view'
  }),
