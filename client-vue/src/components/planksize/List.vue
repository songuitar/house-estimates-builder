        ...
        <tbody>
          <tr
            ...
            <td>
              <router-link
                v-if="item"
                :to="{name: 'PlankSizeShow', params: { id: item['@id'] }}">
                {{ item['@id'] }}
              </router-link>
            </td>
            <td>
            ...
            <td>
              <router-link :to="{name: 'PlankSizeUpdate', params: { id: item['@id'] }}">
                <span
                  class="fa fa-pencil"
                  aria-hidden="true" />
...
export default {
  computed: mapGetters({
    deletedItem: 'planksize/del/deleted',
    error: 'planksize/list/error',
    items: 'planksize/list/items',
    isLoading: 'planksize/list/isLoading',
    view: 'planksize/list/view'
  }),
  ...
  methods: mapActions({
    getPage: 'planksize/list/default'
  })
}
</script>
